...
export const SEED_PRODUCTS: Product[] = [
  SEED_PRODUCT,
  {
    id: 'prod_tea_ctc_kadak_500g',
    name: 'Premium CTC Kadak Chai',
    slug: 'premium-ctc-kadak-chai',
    description: 'Granular brisk Assam leaf for morning milk tea with intense golden color and robust body.',
    sku: 'TN-CTC-500G',
    categoryId: 'chai',
    categoryName: 'Chai Blends',
    weight: 500,
    unit: 'g',
    mrp: 550,
    sellingPrice: 495,
    ...
    images: SEED_PRODUCT.images,
    thumbnail: SEED_PRODUCT.thumbnail,
    isPublished: true,
    isFeatured: true,
    isActive: true,
    createdAt: new Date().toISOString(),
  ...
  {
    id: 'prod_tea_ginger_masala_500g',
    name: 'Tea Nest Ginger Masala Chai',
    slug: 'ginger-masala-chai',
    description: 'Authentic Indian Spiced Tea with Real Ginger, crushed cardamom and premium Assam CTC tea.',
    sku: 'TN-GMC-500G',
    categoryId: 'chai',
    categoryName: 'Chai Blends',
    weight: 500,
  ...
  {
    id: 'prod_tea_orthodox_reserve_500g',
    name: 'Tea Nest Orthodox Reserve',
    slug: 'orthodox-reserve',
    description: 'Whole leaf Assam black tea with golden tips, rich muscatel aroma and delicate malt finish.',
    sku: 'TN-ORT-500G',
    categoryId: 'orthodox',
    categoryName: 'Orthodox Tea',
    weight: 500,
    unit: 'g',
    mrp: 600,
    sellingPrice: 550,
